...
class TicketAllocationLogSchemaContractTest extends TestCase
{
    public function test_legacy_allocation_logs_table_is_not_present(): void
    {
        $this->assertFalse(
            Schema::hasTable('ticket_allocation_logs')
        );
    }
