...
<div class="page-keberangkatan">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Edit Keberangkatan</h1>
            <p class="page-subtitle">
                Perbarui data jadwal keberangkatan
            </p>
        </div>
    ...
    <div class="card card-hover">
        <div class="card-body">
            ...
            <form action="{{ route('operator.keberangkatan.update', $item->id) }}"
                  method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_paket_master"
                            ...
                            @foreach ($paket as $p)
                                <option value="{{ $p->id }}"
                                    @selected(old('id_paket_master', $item->id_paket_master) == $p->id)>
                                    {{ $p->nama_paket }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('kode_keberangkatan', $item->kode_keberangkatan) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('tanggal_berangkat', $item->tanggal_berangkat) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               name="tanggal_pulang"
                               value="{{ old('tanggal_pulang', $item->tanggal_pulang) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               name="seat_terisi"
                               value="{{ old('seat_terisi', $item->seat_terisi) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               name="jumlah_jamaah"
                               value="{{ old('jumlah_jamaah', $item->jumlah_jamaah) }}"
                               class="form-control @error('jumlah_jamaah') is-invalid @enderror">
                        @error('jumlah_jamaah')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="Batal"   @selected(old('status',$item->status)=='Batal')>Batal</option>
                        </select>
                    </div>
